...
harbor-lang-lexer-grid is a Julia project for compilers. It focuses on this technical goal: Create a Julia reference implementation for lexer workflows, centered on stream reduction, windowed input fixtures, and late-data behavior checks.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 160, risk penalty 5, latency penalty 3, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
